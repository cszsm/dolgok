...
internal class ForecastTransformerTest {
    ...
    fun transformHourly(
        data: Pair<ForecastApiModel, cszsm.dolgok.core.domain.result.Result<HourlyForecast, cszsm.dolgok.core.domain.error.DataError>>,
    ) {
        // Given
    ...
    fun transformDaily(
        data: Pair<ForecastApiModel, cszsm.dolgok.core.domain.result.Result<DailyForecast, cszsm.dolgok.core.domain.error.DataError>>,
    ) {
        // Given
        val response = data.first
    ...
    private companion object {
        ...
        val transformHourlyTestData =
            listOf<Pair<ForecastApiModel, cszsm.dolgok.core.domain.result.Result<HourlyForecast, cszsm.dolgok.core.domain.error.DataError>>>(
                Pair(
                    RESPONSE.HOURLY.COMPLETE,
                    cszsm.dolgok.core.domain.result.Result.Success(TRANSFORMED.HOURLY.COMPLETE)
                ),
                Pair(
                    RESPONSE.HOURLY.TIME_WRONG_DATA_FORMAT,
                    cszsm.dolgok.core.domain.result.Result.Failure(cszsm.dolgok.core.domain.error.DataError.WRONG_DATA_FORMAT)
                ),
                Pair(
                    RESPONSE.HOURLY.TEMPERATURE_INCOMPLETE,
                    cszsm.dolgok.core.domain.result.Result.Failure(cszsm.dolgok.core.domain.error.DataError.INCOMPLETE_DATA)
                ),
            )

        @Suppress("unused")
        val transformDailyTestData =
            listOf<Pair<ForecastApiModel, cszsm.dolgok.core.domain.result.Result<DailyForecast, cszsm.dolgok.core.domain.error.DataError>>>(
                Pair(
                    RESPONSE.DAILY.COMPLETE,
                    cszsm.dolgok.core.domain.result.Result.Success(TRANSFORMED.DAILY.COMPLETE)
                ),
                Pair(
