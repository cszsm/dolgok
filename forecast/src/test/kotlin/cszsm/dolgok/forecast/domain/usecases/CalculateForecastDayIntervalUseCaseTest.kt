...
internal class CalculateForecastDayIntervalUseCaseTest {

    private val mockGetCurrentTimeUseCase: cszsm.dolgok.core.domain.usecases.GetCurrentTimeUseCase = mockk()
