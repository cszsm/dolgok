...
internal class GetHourlyForecastUseCaseTest {
    ...
    private companion object {
        ...
        val RESULT: cszsm.dolgok.core.domain.result.Result.Success<HourlyForecast, cszsm.dolgok.core.domain.error.DataError> = mockk()
    }
}