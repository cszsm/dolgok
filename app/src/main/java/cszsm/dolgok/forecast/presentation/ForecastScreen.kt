...
import cszsm.dolgok.forecast.presentation.ForecastScreenState.ForecastState
        ...
        Column(modifier = Modifier.padding(contentPadding)) {
            ...
            HorizontalPager(
                ...
                ForecastPage(
                    ...
                    hourlyForecastState = state.hourlyForecastState,
                    dailyForecastState = state.dailyForecastState,
                    selectedWeatherVariable = state.selectedWeatherVariable,
...
private fun ForecastPage(
    ...
    hourlyForecastState: ForecastState<HourlyForecast>,
    dailyForecastState: ForecastState<DailyForecast>,
...
private fun ForecastContent_Preview() {
    ...
    ForecastContent(
        state = ForecastScreenState(hourlyForecastState = ForecastState(forecast = hourlyForecast)),
        onEvent = {},
    )
}
